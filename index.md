...
### 📘 Documentation
- [Governance](GOVERNANCE.md) — Platform structure, curation process, and ethical framework
- [Privacy Policy](PRIVACY.md) — How we protect patient data (GDPR compliant)
- [Terms of Submission](TERMS.md) — Contributor guidelines and clickwrap agreement
...
### For Clinicians
- **Share exceptional cases** that could advance precision oncology
- **Gain recognition** with your name and institution credited
- **Network internationally** with experts facing similar cases
- **Contribute to science** while maintaining patient privacy

### For Researchers
- **Access unique data** not available in conventional databases
- **Generate hypotheses** from real-world exceptional responders
- **Identify biomarkers** linked to unexpected clinical outcomes
- **Free and open** under Creative Commons CC BY 4.0 license

### For Patients
- **Your case helps others** by advancing cancer treatment knowledge
- **Privacy protected** through rigorous pseudonymization
- **Voluntary participation** with right to object at any time
- **No impact on care** — objection does not affect treatment quality
...
✅ **International:** Accepting submissions from all countries  

---

## Case Examples *(Placeholder)*

### Featured Cases

**Case #2026-0042: EGFR T790M with unexpected osimertinib hypersensitivity**  
*Lung adenocarcinoma, Stage IV, Female 65-70 years*  
Complete response within 4 weeks but severe skin toxicity (Grade 4). Novel EGFR variant co-occurring with CYP2D6 poor metabolizer status.

**Case #2026-0038: BRAF V600E melanoma with paradoxical progression**  
*Metastatic melanoma, Male 55-60 years*  
Progressive disease on vemurafenib despite confirmed V600E mutation. Molecular profiling revealed concurrent PTEN loss and novel NRAS mutation.

[View All Cases →](https://ppegc.org/cases)
...
- **Gustave Roussy Institute** — Host institution and infrastructure support
- *[Add partner logos and names as you acquire them]*
